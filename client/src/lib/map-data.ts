...
export const mapInstitutions: MapInstitution[] = [
  { name: "Shasta College", type: "Community College", county: "Shasta", x: 228, y: 369, marker: "college" },
  { name: "Simpson University", type: "University (Private)", county: "Shasta", x: 221, y: 363, marker: "university" },
  { name: "College of the Siskiyous", type: "Community College", county: "Siskiyou", x: 232, y: 92, marker: "college" },
  { name: "Lassen Community College", type: "Community College", county: "Lassen", x: 405, y: 388, marker: "college" },
  { name: "Butte College", type: "Community College", county: "Butte", x: 331, y: 589, marker: "college" },
  ...
  { name: "Butte County Office of Education", type: "County Office of Education", county: "Butte", x: 310, y: 577, marker: "county-office" },
  { name: "Siskiyou County Office of Education", type: "County Office of Education", county: "Siskiyou", x: 245, y: 92, marker: "county-office" },
...
export const offMapInstitutions: MapInstitution[] = [
  ...
  { name: "Southern Oregon University", type: "University (Out-of-State)", county: null, x: 0, y: 0, marker: "university" },
  { name: "Western Governors University", type: "University (Online)", county: null, x: 0, y: 0, marker: "online" },
  { name: "REACH University", type: "University (Online)", county: null, x: 0, y: 0, marker: "online" },
];
