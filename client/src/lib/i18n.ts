...
const translations: Record<string, Record<Language, string>> = {
  ...
  "nav.scholarships": { en: "Scholarship Finder", es: "Buscador de Becas" },

  "scholarships.title": { en: "Scholarship Finder", es: "Buscador de Becas" },
  "scholarships.subtitle": { en: "Find scholarships you qualify for", es: "Encuentra becas para las que calificas" },
  "scholarships.welcome": { en: "Hi! I'll help you find scholarships you may be eligible for. I'll ask you a few questions about your situation, and then match you with relevant opportunities. You can skip any question you'd prefer not to answer.", es: "¡Hola! Te ayudaré a encontrar becas para las que puedas ser elegible. Te haré algunas preguntas sobre tu situación y luego te conectaré con oportunidades relevantes. Puedes omitir cualquier pregunta que prefieras no responder." },
  "scholarships.countyQuestion": { en: "First, which county do you live in? This helps narrow down local scholarships.", es: "Primero, ¿en qué condado vives? Esto ayuda a encontrar becas locales." },
  "scholarships.skip": { en: "Skip", es: "Omitir" },
  "scholarships.continue": { en: "Continue", es: "Continuar" },
  "scholarships.seeResults": { en: "See Results So Far", es: "Ver Resultados Hasta Ahora" },
  "scholarships.results": { en: "Results", es: "Resultados" },
  "scholarships.matchScore": { en: "Match", es: "Coincidencia" },
  "scholarships.apply": { en: "Apply", es: "Aplicar" },
  "scholarships.noResults": { en: "No matching scholarships found. Try answering more questions or adjusting your answers.", es: "No se encontraron becas que coincidan. Intenta responder más preguntas o ajustar tus respuestas." },
  "scholarships.answering": { en: "Finding scholarships for you...", es: "Buscando becas para ti..." },
  "scholarships.noCriteria": { en: "No scholarship criteria have been set up yet. Please check back later!", es: "Aún no se han configurado criterios de becas. ¡Vuelve más tarde!" },
  "scholarships.back": { en: "Back", es: "Atrás" },
  "scholarships.startOver": { en: "Start Over", es: "Comenzar de Nuevo" },
  "scholarships.eligible": { en: "Eligible", es: "Elegible" },
  "scholarships.notEligible": { en: "May Not Qualify", es: "Puede No Calificar" },
  "scholarships.matched": { en: "Matched", es: "Coincide" },
